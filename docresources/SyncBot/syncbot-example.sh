...
export MESSAGE_CONVERTER_PRIVACY_INDICATORS_OBJECT="{
    \"emoji\":\"💭\",
    \"word\":\"whisper\",
    \"char\":\"~\"
}"
export MESSAGE_CONVERTER_PUBLICITY_INDICATORS_OBJECT="{
    \"emoji\":\"💬\",
    \"word\":\"comment\",
    \"char\":\"%\"
}"
export MESSAGE_CONVERTER_IMG_BASE_URL="http://example.com/logo.svg"
export MESSAGE_CONVERTER_MESSAGES_OF_THE_DAY="[

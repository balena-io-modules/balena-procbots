...
const generateVersion: RepoWorkerMethod  = function (data: any) {
	console.log(`Running versionist...`);
	...
	// Create new work dir.
	return temp.mkdirAsync(`${repoName}-${commitHash}`)
	.then((tempDir: string) => {
		fullPath = tempDir;

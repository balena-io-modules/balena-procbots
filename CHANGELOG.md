...
* Add debugging logs to aid front <-> discourse sync troubleshooting [Kostas Lekkas]
...
* SyncBot: Prevent messages containing <this> style email citations from looping #486 [Andrew Lucas]
